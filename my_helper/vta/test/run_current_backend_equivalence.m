...
if isfield(summary, 'actual_fem_solve_count') && ...
    ...
    actualFemSolveCount = double(summary.actual_fem_solve_count);
elseif isfield(manifest, 'accumulated_fem_solve_count') && ...
    ...
    actualFemSolveCount = double(manifest.accumulated_fem_solve_count);
end
summary.actual_fem_solve_count = actualFemSolveCount;
