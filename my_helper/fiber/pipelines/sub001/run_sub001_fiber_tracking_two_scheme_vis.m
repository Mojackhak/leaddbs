...
cfgTwo.vta.modelKey = 'simbio';
cfgTwo.vta.model = mh_fiber_model_name(cfgTwo.vta.modelKey);
...
mh_vta_run_built_stimulation_tasks(cfgTwo, STwo, optionsTwo, stimFoldersTwo, ...
    'ModelKey', cfgTwo.vta.modelKey);
...
cfgOne.vta.modelKey = 'simbio_onesolve';
cfgOne.vta.model = mh_fiber_model_name(cfgOne.vta.modelKey);
...
mh_vta_run_built_stimulation_tasks(cfgOne, SOne, optionsOne, stimFoldersOne, ...
    'ModelKey', cfgOne.vta.modelKey);
