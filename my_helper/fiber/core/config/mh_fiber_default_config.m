...
cfg.vta.space = mh_vta_default_config_space();
cfg.vta.gmAtlas = mh_vta_default_gm_atlas();
executionDefaults = mh_vta_default_execution_options();
cfg.vta.parallel = executionDefaults.parallel;
cfg.vta.parallelWorkers = executionDefaults.parallelWorkers;
cfg.vta.executionMode = executionDefaults.executionMode;
cfg.vta.matlabExe = executionDefaults.matlabExe;
cfg.vta.condaEnv = executionDefaults.condaEnv;
cfg.vta.processDryRun = executionDefaults.processDryRun;
cfg.vta.processWorkDir = executionDefaults.processWorkDir;
cfg.vta.processPollSeconds = executionDefaults.processPollSeconds;
cfg.vta.processTimeoutSeconds = executionDefaults.processTimeoutSeconds;
