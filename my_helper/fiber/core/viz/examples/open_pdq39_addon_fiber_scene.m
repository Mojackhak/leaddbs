% Open the completed PDQ-39 add-on normative-fiber model as an interactive scene.
...
spec.ViewStruct = fiberViews.addon{1};
...
set(pdq39FiberScene.figure, ...
    'Name', sprintf('PDQ-39 add-on fiber | tau %g | Coverage %g', ...
