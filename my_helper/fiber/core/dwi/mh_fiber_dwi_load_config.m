...
schema.dwi = struct( ...
    ...
    'b0_reference', struct('strategy', leaf, 'threshold', leaf), ...
...
config.dwi = struct( ...
    ...
    'b0_reference', struct('strategy', 'mean', 'threshold', 10), ...
...
config.dwi.b0_reference.strategy = require_enum( ...
    config.dwi.b0_reference.strategy, {'mean', 'last'}, ...
    'dwi.b0_reference.strategy');
config.dwi.b0_reference.threshold = require_scalar_number( ...
    config.dwi.b0_reference.threshold, 'dwi.b0_reference.threshold');
if config.dwi.b0_reference.threshold <= 0
    error('mh_fiber_dwi_load_config:InvalidB0Threshold', ...
        'dwi.b0_reference.threshold must be positive.');
end
