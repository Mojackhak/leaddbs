...
def build_report_row(
    *,
    ...
    row = {
        ...
        "fiber_density_label_cache_status": density_readiness["fiber_density_label_cache_status"],
        "fiber_basic_density_cache_status": density_readiness["fiber_basic_density_cache_status"],
        "fiber_label_cache_status": density_readiness["fiber_label_cache_status"],
        "fiber_fdr_cache_status": density_readiness["fiber_fdr_cache_status"],
        "fiber_enrichment_cache_status": density_readiness["fiber_enrichment_cache_status"],
