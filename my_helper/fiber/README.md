...
The standalone Python atlas builder under `core/whole_brain_roi_atlas` resamples all 198 HybraPD labels to the Lead-DBS 0.5 mm reference, exports 150 non-white-matter Lead-DBS ROI masks plus 48 hidden white-matter QC masks, and counts both endpoints of every dTOR fiber using strict containing-voxel assignment. See `core/whole_brain_roi_atlas/README.md` for validation, build, and status commands.
