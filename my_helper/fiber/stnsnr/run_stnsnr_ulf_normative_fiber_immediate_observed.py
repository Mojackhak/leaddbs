#!/usr/bin/env python3
"""Pipeline entry point for D normative-fiber same-day immediate outputs."""
...
def main() -> int:
    ...
    from stnsnr_ulf_normative_fiber_immediate_observed import main as immediate_main

    return immediate_main(with_stnsnr_defaults(sys.argv[1:], repo_root))
