function lead_job
% - Lead-DBS Job created on 12-Aug-2025 02:44:41 -
% --------------------------------------
...
options.atlassetn = 19;
options.atlasset = 'Custom_Ewert_Zhang_Middlebrooks';
...
options.uipatdirs = {'A:\STNSNr\derivatives\leaddbs\sub-LiChangXu'};
...
options.prefs.lc.datadir = 'F:\GitHub\anipose_m\Mojackhak\leaddbs\connectomes\';
...
options.prefs.d3.showdirarrows = 1;
...
options.prefs.slicer.dir = 'F:\Software\Slicer 5.6.2\Slicer.exe';
...
options.prefs.genetics.dbdir = 'F:\GitHub\anipose_m\Mojackhak\leaddbs\templates\space\MNI152NLin2009bAsym\genetics\';
...
options.prefs.conda.install_path = 'F:\miniconda';
...
options.prefs.machine.normsettings.ants_numcores = '32';
...
options.prefs.machine.vatsettings.butenko_calcAxonActivation = true;
options.prefs.machine.vatsettings.butenko_connectome = 'PPMI 85 (Ewert 2017)';
options.prefs.machine.vatsettings.butenko_axonLength = 15;
...
options.prefs.machine.vatsettings.butenko_calcPAM = true;
options.prefs.machine.vatsettings.butenko_removeElectrode = 1;
options.prefs.machine.vatsettings.butenko_axonModel = 'MRG2002';
...
options.prefs.machine.vatsettings.butenko_tensorData = 'IITMeanTensor.nii.gz';
options.prefs.machine.vatsettings.butenko_AdaptiveRef = 0;
options.prefs.machine.vatsettings.butenko_encapsulation = 'None';
options.prefs.machine.vatsettings.butenko_adaptive_ethresh = true;
