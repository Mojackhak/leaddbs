...
validation compares all three copies. Forty-one focused tests and all 51
visualization tests passed. A fresh complete dual-frequency and visualization
regression then passed 843 tests and 329 subtests in 136.25 seconds with
