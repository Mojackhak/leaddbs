...
it. The formal-target worklist, formal-readiness audit, final reporting,
all-endpoint reporting, C same-day immediate driver, and C/D gain/total-ULF
sensitivity drivers use this helper; broader migration remains part of the
remaining shared score/stale-output/manifest-schema work.
