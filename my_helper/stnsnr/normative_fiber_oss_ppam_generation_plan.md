...
- FDR cache, enrichment cache, and jitter inputs remain separate blockers. FDR and enrichment cache definitions are maintained in `my_helper/stnsnr/normative_fiber_fdr_enrichment_cache_definition.md`; they are not generated by this OSS/pPAM sidecar plan.
