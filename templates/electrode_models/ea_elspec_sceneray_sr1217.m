function electrode=ea_elspec_sceneray_sr1217(varargin)
...
options.elmodel='SceneRay SR1217';
...
% non-uniform spacing
electrode.tail_position=[0,0,elspec.tip_length+elspec.numContacts*elspec.contact_length+sum(elspec.contact_spacing)-0.5*elspec.contact_length];
