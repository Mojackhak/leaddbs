...
if ~nargin
    varargout{1}={'Medtronic 3389', 'Medtronic 3387', 'Medtronic 3391', 'Medtronic B33005', 'Medtronic B33015', ...
        ...
        'SceneRay SR1200', 'SceneRay SR1202', 'SceneRay SR1207', 'SceneRay SR1210', 'SceneRay SR1211', ...
        'SceneRay SR1212', 'SceneRay SR1217', 'SceneRay SR1242', ...
    ...
    varargout{2}={'medtronic_3389', 'medtronic_3387', 'medtronic_3391', 'medtronic_b33005', 'medtronic_b33015', ...
        ...
        'sceneray_sr1200', 'sceneray_sr1202', 'sceneray_sr1207', 'sceneray_sr1210', 'sceneray_sr1211', ...
        'sceneray_sr1212', 'sceneray_sr1217', 'sceneray_sr1242', ...
...
switch elmodel
    ...
    case 'SceneRay SR1202'
        ...
        elspec.etageidx=num2cell(1:elspec.numContacts);
        elspec.forstimulation=1;
    case 'SceneRay SR1207'
        elspec.matfname='sceneray_sr1207';
        ...
        elspec.tip_length=1;
        elspec.contact_spacing=0.5;
        elspec.numContacts=3;
        elspec.tipiscontact=0;
        elspec.contactnames={'K3 (R)','K4 (R)','K5 (R)','K0 (L)','K1 (L)','K2 (L)'};
        elspec.isdirected=0;
        elspec.etagenames{1}=elspec.contactnames(1:length(elspec.contactnames)/2);
        elspec.etagenames{2}=elspec.contactnames((length(elspec.contactnames)/2)+1:end);
        elspec.etageidx=num2cell(1:elspec.numContacts);
    ...
    case 'SceneRay SR1212'
        ...
        elspec.etageidx=num2cell(1:elspec.numContacts);
        elspec.forstimulation=1;
    case 'SceneRay SR1217'
        elspec.matfname='sceneray_sr1217';
        elspec.lead_diameter=1.27;
        elspec.lead_color=0.7;
        elspec.contact_length=1.5;
        elspec.contact_diameter=1.27;
        ...
        elspec.tip_color=0.7;
        elspec.tip_length=1.5;
        elspec.contact_spacing=[0.5,0.5,1.0];
        elspec.numContacts=4;
        elspec.tipiscontact=0;
        elspec.contactnames={'K4 (R)','K5 (R)','K6 (R)','K7 (R)','K0 (L)','K1 (L)','K2 (L)','K3 (L)'};
        elspec.isdirected=0;
