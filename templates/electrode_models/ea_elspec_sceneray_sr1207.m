function electrode = ea_elspec_sceneray_sr1207(vizz)
% Creates the FEM-compatible electrode model for SceneRay SR1207.
% It's based on the mesh generated using SketchUp and tetgen.
% _________________________________________________________________________
% Copyright (C) 2021 Charite University Medicine Berlin
% Ningfei Li

options.elmodel = 'SceneRay SR1207';
...
electrode.tail_position=[0,0,elspec.tip_length+elspec.numContacts*elspec.contact_length+(elspec.numContacts-1)*elspec.contact_spacing-0.5*elspec.contact_length];
